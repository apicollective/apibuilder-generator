 ...
 * apibuilder 0.15.33 localhost 9000/apicollective/apibuilder-union-of-unions/latest/play_2_6_client
 */
package io.apibuilder.union.of.unions.v0.models {
...
package io.apibuilder.union.of.unions.v0.models {
  ...
  package object json {
    ...
    def jsObjectGroup(obj: io.apibuilder.union.of.unions.v0.models.Group): play.api.libs.json.JsObject = {
    ...
    implicit def jsonWritesApibuilderUnionOfUnionsGroup: play.api.libs.json.Writes[Group] = {
      (obj: io.apibuilder.union.of.unions.v0.models.Group) => {
        jsObjectGroup(obj)
      }
    }
    ...
    def jsObjectGuestUser(obj: io.apibuilder.union.of.unions.v0.models.GuestUser): play.api.libs.json.JsObject = {
      (obj.email match {
    ...
    implicit def jsonWritesApibuilderUnionOfUnionsGuestUser: play.api.libs.json.Writes[GuestUser] = {
      (obj: io.apibuilder.union.of.unions.v0.models.GuestUser) => {
    ...
    def jsObjectRegisteredUser(obj: io.apibuilder.union.of.unions.v0.models.RegisteredUser): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonWritesApibuilderUnionOfUnionsRegisteredUser: play.api.libs.json.Writes[RegisteredUser] = {
      (obj: io.apibuilder.union.of.unions.v0.models.RegisteredUser) => {
    ...
    implicit def jsonReadsApibuilderUnionOfUnionsParty: play.api.libs.json.Reads[Party] = new play.api.libs.json.Reads[Party] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[Party] = {
        (js \ "discriminator").asOpt[String].getOrElse("user") match {
          case "registered_user" => js.validate[io.apibuilder.union.of.unions.v0.models.RegisteredUser]
          case "guest_user" => js.validate[io.apibuilder.union.of.unions.v0.models.GuestUser]
          case "group" => js.validate[io.apibuilder.union.of.unions.v0.models.Group]
          case other => play.api.libs.json.JsSuccess(io.apibuilder.union.of.unions.v0.models.PartyUndefinedType(other))
        }
      }
    }

    def jsObjectParty(obj: io.apibuilder.union.of.unions.v0.models.Party): play.api.libs.json.JsObject = {
      obj match {
        case x: io.apibuilder.union.of.unions.v0.models.RegisteredUser => jsObjectRegisteredUser(x)
        case x: io.apibuilder.union.of.unions.v0.models.GuestUser => jsObjectGuestUser(x)
        case x: io.apibuilder.union.of.unions.v0.models.Group => jsObjectGroup(x)
        case other => {
    ...
    implicit def jsonWritesApibuilderUnionOfUnionsParty: play.api.libs.json.Writes[Party] = {
      (obj: io.apibuilder.union.of.unions.v0.models.Party) => {
        jsObjectParty(obj)
      }
    }
    ...
    implicit def jsonReadsApibuilderUnionOfUnionsUser: play.api.libs.json.Reads[User] = new play.api.libs.json.Reads[User] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[User] = {
        (js \ "discriminator").asOpt[String].getOrElse { sys.error("Union[User] requires a discriminator named 'discriminator' - this field was not found in the Json Value") } match {
          case "registered_user" => js.validate[io.apibuilder.union.of.unions.v0.models.RegisteredUser]
          case "guest_user" => js.validate[io.apibuilder.union.of.unions.v0.models.GuestUser]
          case other => play.api.libs.json.JsSuccess(io.apibuilder.union.of.unions.v0.models.UserUndefinedType(other))
        }
      }
    }

    def jsObjectUser(obj: io.apibuilder.union.of.unions.v0.models.User): play.api.libs.json.JsObject = {
      obj match {
        case x: io.apibuilder.union.of.unions.v0.models.RegisteredUser => jsObjectRegisteredUser(x)
        case x: io.apibuilder.union.of.unions.v0.models.GuestUser => jsObjectGuestUser(x)
        case other => {
    ...
    implicit def jsonWritesApibuilderUnionOfUnionsUser: play.api.libs.json.Writes[User] = {
      (obj: io.apibuilder.union.of.unions.v0.models.User) => {
        jsObjectUser(obj)
      }
    }
  }
...
package io.apibuilder.union.of.unions.v0 {
...
package io.apibuilder.union.of.unions.v0 {
  ...
  object Constants {
    ...
    val Namespace = "io.apibuilder.union.of.unions.v0"
    val UserAgent = "apibuilder 0.15.33 localhost 9000/apicollective/apibuilder-union-of-unions/latest/play_2_6_client"
    val Version = "0.9.63"
    val VersionMajor = 0
    ...
    def parseJson[T](
      ...
      f(play.api.libs.json.Json.parse(r.body)) match {
        ...
        case play.api.libs.json.JsError(errors) => {
          throw io.apibuilder.union.of.unions.v0.errors.FailedRequest(r.status, s"Invalid json for class[" + className + "]: " + errors.mkString(" "))
        }
      }
    }
