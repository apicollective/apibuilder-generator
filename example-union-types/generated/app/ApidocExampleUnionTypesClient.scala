 ...
 * apidoc:0.9.3 http://localhost:9000/gilt/apidoc-example-union-types/0.0.1-dev/play_2_3_client
 */
...
package com.gilt.apidoc.example.union.types.v0 {
  ...
  object Bindables {
    ...
    // Enum: Bar
    private val enumBarNotFound = (key: String, e: Exception) => s"Unrecognized $key, should be one of ${com.gilt.apidoc.example.union.types.v0.models.Bar.all.mkString(", ")}"
    ...
    // Enum: Foo
    private val enumFooNotFound = (key: String, e: Exception) => s"Unrecognized $key, should be one of ${com.gilt.apidoc.example.union.types.v0.models.Foo.all.mkString(", ")}"
...
package com.gilt.apidoc.example.union.types.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.9.3 http://localhost:9000/gilt/apidoc-example-union-types/0.0.1-dev/play_2_3_client"
