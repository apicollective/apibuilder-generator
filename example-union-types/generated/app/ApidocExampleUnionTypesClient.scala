 ...
 * apidoc:0.9.0 http://localhost:9000/gilt/apidoc-example-union-types/0.0.1-dev/play_2_3_client
 */
...
package com.gilt.apidoc.example.union.types.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.9.0 http://localhost:9000/gilt/apidoc-example-union-types/0.0.1-dev/play_2_3_client"
