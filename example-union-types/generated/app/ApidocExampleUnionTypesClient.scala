 ...
 * apidoc:0.7.41 http://localhost:9000/gilt/apidoc-example-union-types/0.0.1-dev/play_2_3_client
 */
...
package com.gilt.apidoc.example.union.types.v0 {
  ...
  class Client(apiUrl: String, auth: scala.Option[com.gilt.apidoc.example.union.types.v0.Authorization] = None) {
    ...
    private val UserAgent = "apidoc:0.7.41 http://localhost:9000/gilt/apidoc-example-union-types/0.0.1-dev/play_2_3_client"
