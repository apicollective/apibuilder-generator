 ...
 * apidoc:0.11.3 http://localhost:9000/bryzek/apidoc-example-union-types/0.3.2/play_2_4_client
 */
...
package com.bryzek.apidoc.example.union.types.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.3 http://localhost:9000/bryzek/apidoc-example-union-types/0.3.2/play_2_4_client"
    val Version = "0.3.2"
    val VersionMajor = 0
