...
package com.bryzek.apidoc.example.union.types.discriminator.v0.models {
  ...
  package object json {
    ...
    def jsonWritesApidocExampleUnionTypesDiscriminatorSystemUser(obj: com.bryzek.apidoc.example.union.types.discriminator.v0.models.SystemUser) = {
...
package com.bryzek.apidoc.example.union.types.discriminator.v0 {
  ...
  object Constants {
    ...
    val Namespace = "com.bryzek.apidoc.example.union.types.discriminator.v0"
  ...
  class Client(
    ...
    logger.info(s"Initializing com.bryzek.apidoc.example.union.types.discriminator.v0.Client for url $baseUrl")
    ...
    object Users extends Users {
      ...
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[Seq[com.bryzek.apidoc.example.union.types.discriminator.v0.models.User]] = {
  ...
  package interfaces {
    ...
    trait Client {
      def baseUrl: String
      def users: com.bryzek.apidoc.example.union.types.discriminator.v0.Users
    }
