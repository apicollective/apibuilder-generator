...
package io.apibuilder.example.union.types.discriminator.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsApidocExampleUnionTypesDiscriminatorSystemUser = new play.api.libs.json.Reads[io.apibuilder.example.union.types.discriminator.v0.models.SystemUser] {
    ...
    implicit def jsonWritesApidocExampleUnionTypesDiscriminatorSystemUser: play.api.libs.json.Writes[SystemUser] = {
      new play.api.libs.json.Writes[io.apibuilder.example.union.types.discriminator.v0.models.SystemUser] {
        def writes(obj: io.apibuilder.example.union.types.discriminator.v0.models.SystemUser) = {
          jsonWritesApidocExampleUnionTypesDiscriminatorSystemUser(obj)
        }
      }
    }
    ...
    def jsObjectGuestUser(obj: io.apibuilder.example.union.types.discriminator.v0.models.GuestUser) = {
    ...
    def jsObjectRegisteredUser(obj: io.apibuilder.example.union.types.discriminator.v0.models.RegisteredUser) = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id),
    ...
    def jsObjectUser(obj: io.apibuilder.example.union.types.discriminator.v0.models.User) = {
      obj match {
    ...
    implicit def jsonWritesApidocExampleUnionTypesDiscriminatorUser: play.api.libs.json.Writes[User] = {
      new play.api.libs.json.Writes[io.apibuilder.example.union.types.discriminator.v0.models.User] {
        def writes(obj: io.apibuilder.example.union.types.discriminator.v0.models.User) = {
          jsObjectUser(obj)
        }
      }
    }
...
package io.apibuilder.example.union.types.discriminator.v0 {
  ...
  object Bindables {
    ...
    implicit val queryStringBindableEnumSystemUser = new QueryStringBindable.Parsing[io.apibuilder.example.union.types.discriminator.v0.models.SystemUser](
      SystemUser.fromString(_).get, _.toString, enumSystemUserNotFound
    )
...
package io.apibuilder.example.union.types.discriminator.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.19 http://localhost:9000/bryzek/apidoc-example-union-types-discriminator/0.3.46/play_2_4_client"
    val Version = "0.3.46"
    val VersionMajor = 0
    ...
    object Users extends Users {
      override def get(
        ...
        _executeRequest("GET", s"/users", requestHeaders = requestHeaders).map {
          ...
          case r => throw new io.apibuilder.example.union.types.discriminator.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200")
        }
      }
      ...
      override def getById(
        ...
        _executeRequest("GET", s"/users/${play.utils.UriEncoding.encodePathSegment(id, "UTF-8")}", requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 404 => throw new io.apibuilder.example.union.types.discriminator.v0.errors.UnitResponse(r.status)
          case r => throw new io.apibuilder.example.union.types.discriminator.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 404")
        }
      }
      ...
      override def post(
        ...
        _executeRequest("POST", s"/users", body = Some(payload), requestHeaders = requestHeaders).map {
          ...
          case r => throw new io.apibuilder.example.union.types.discriminator.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 201")
        }
      }
    }
    ...
    def parseJson[T](
      ...
      f(play.api.libs.json.Json.parse(r.body)) match {
        ...
        case play.api.libs.json.JsError(errors) => {
          throw new io.apibuilder.example.union.types.discriminator.v0.errors.FailedRequest(r.status, s"Invalid json for class[" + className + "]: " + errors.mkString(" "))
        }
      }
    }
