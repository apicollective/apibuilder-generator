 ...
 * apidoc:0.10.1 http://localhost:9000/bryzek/apidoc-example-union-types-discriminator/0.2.1/play_2_4_client
 */
...
package com.bryzek.apidoc.example.union.types.discriminator.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.10.1 http://localhost:9000/bryzek/apidoc-example-union-types-discriminator/0.2.1/play_2_4_client"
    val Version = "0.2.1"
    val VersionMajor = 0
