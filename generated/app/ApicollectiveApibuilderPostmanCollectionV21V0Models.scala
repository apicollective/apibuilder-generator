 ...
 * apibuilder 0.14.59 app.apibuilder.io/apicollective/apibuilder-postman-collection-v2-1/0.0.1-dev/play_2_x_json
 */
...
package io.apibuilder.postman.collection.v21.v0.models {
  ...
  package object json {
    ...
    def jsObjectItems(obj: io.apibuilder.postman.collection.v21.v0.models.Items): play.api.libs.json.JsObject = {
      obj match {
        case x: io.apibuilder.postman.collection.v21.v0.models.Item => jsObjectItem(x) ++ play.api.libs.json.Json.obj("type" -> "item")
        case x: io.apibuilder.postman.collection.v21.v0.models.Folder => jsObjectFolder(x) ++ play.api.libs.json.Json.obj("type" -> "folder")
        case other => {
