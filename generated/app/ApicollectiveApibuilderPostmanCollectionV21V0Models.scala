 ...
 * User agent: apibuilder app.apibuilder.io/apicollective/apibuilder-postman-collection-v2-1/latest/play_2_x_json
 */
...
package io.apibuilder.postman.collection.v21.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsApiBuilderPostmanCollectionV21Folder: play.api.libs.json.Reads[io.apibuilder.postman.collection.v21.v0.models.Folder] = {
      for {
    ...
    implicit def jsonReadsApiBuilderPostmanCollectionV21Item: play.api.libs.json.Reads[io.apibuilder.postman.collection.v21.v0.models.Item] = {
      for {
        id <- (__ \ "id").readNullable[String]
    ...
    implicit def jsonReadsApiBuilderPostmanCollectionV21Items: play.api.libs.json.Reads[io.apibuilder.postman.collection.v21.v0.models.Items] = (js: play.api.libs.json.JsValue) => {
