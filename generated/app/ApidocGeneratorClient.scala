 ...
 * apidoc:0.7.39 http://www.apidoc.me/gilt/apidoc-generator/0.7.36-dev/play_2_3_client
 */
package com.gilt.apidocgenerator.models {
  ...
  case class Operation(
    ...
    responses: Map[String, com.gilt.apidocgenerator.models.Response] = Map.empty
  )
  ...
  case class Service(
    ...
    enums: Map[String, com.gilt.apidocgenerator.models.Enum],
    models: Map[String, com.gilt.apidocgenerator.models.Model],
    resources: Map[String, com.gilt.apidocgenerator.models.Resource]
  )
  ...
  package object json {
    ...
    implicit def jsonReadsApidocGeneratorOperation: play.api.libs.json.Reads[Operation] = {
      (
        ...
        (__ \ "responses").readNullable[Map[String, com.gilt.apidocgenerator.models.Response]].map(_.getOrElse(Map.empty))
      )(Operation.apply _)
    }
    ...
    implicit def jsonWritesApidocGeneratorOperation: play.api.libs.json.Writes[Operation] = {
      (
        ...
        (__ \ "responses").write[Map[String, com.gilt.apidocgenerator.models.Response]]
    ...
    implicit def jsonWritesApidocGeneratorResponse: play.api.libs.json.Writes[Response] = new play.api.libs.json.Writes[Response] {
    ...
    implicit def jsonReadsApidocGeneratorService: play.api.libs.json.Reads[Service] = {
      (
        ...
        (__ \ "enums").readNullable[Map[String, com.gilt.apidocgenerator.models.Enum]].map(_.getOrElse(Map.empty)) and
        (__ \ "models").readNullable[Map[String, com.gilt.apidocgenerator.models.Model]].map(_.getOrElse(Map.empty)) and
        (__ \ "resources").readNullable[Map[String, com.gilt.apidocgenerator.models.Resource]].map(_.getOrElse(Map.empty))
      )(Service.apply _)
    }
    ...
    implicit def jsonWritesApidocGeneratorService: play.api.libs.json.Writes[Service] = {
      (
        ...
        (__ \ "enums").write[Map[String, com.gilt.apidocgenerator.models.Enum]] and
        (__ \ "models").write[Map[String, com.gilt.apidocgenerator.models.Model]] and
        (__ \ "resources").write[Map[String, com.gilt.apidocgenerator.models.Resource]]
...
package com.gilt.apidocgenerator {
  ...
  class Client(apiUrl: String, apiToken: scala.Option[String] = None) {
    ...
    private val UserAgent = "apidoc:0.7.39 http://www.apidoc.me/gilt/apidoc-generator/0.7.36-dev/play_2_3_client"
