 ...
 * User agent: apibuilder app.apibuilder.io/apicollective/postman-generator-attributes/latest/play_2_9_scala_3_client
 */
...
package io.postman.generator.attributes.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsPostmanGeneratorAttributesAttributeName: play.api.libs.json.Reads[io.postman.generator.attributes.v0.models.AttributeName] = new play.api.libs.json.Reads[io.postman.generator.attributes.v0.models.AttributeName] {
    ...
    implicit def jsonWritesPostmanGeneratorAttributesAttributeName: play.api.libs.json.Writes[AttributeName] = {
      (obj: io.postman.generator.attributes.v0.models.AttributeName) => {
        io.postman.generator.attributes.v0.models.json.jsonWritesPostmanGeneratorAttributesAttributeName(obj)
      }
    }

    implicit def jsonReadsPostmanGeneratorAttributesBasicAuth: play.api.libs.json.Reads[io.postman.generator.attributes.v0.models.BasicAuth] = {
      for {
    ...
    implicit def jsonWritesPostmanGeneratorAttributesBasicAuth: play.api.libs.json.Writes[BasicAuth] = {
      (obj: io.postman.generator.attributes.v0.models.BasicAuth) => {
        io.postman.generator.attributes.v0.models.json.jsObjectBasicAuth(obj)
      }
    }

    implicit def jsonReadsPostmanGeneratorAttributesObjectReference: play.api.libs.json.Reads[io.postman.generator.attributes.v0.models.ObjectReference] = {
      for {
    ...
    implicit def jsonWritesPostmanGeneratorAttributesObjectReference: play.api.libs.json.Writes[ObjectReference] = {
      (obj: io.postman.generator.attributes.v0.models.ObjectReference) => {
        io.postman.generator.attributes.v0.models.json.jsObjectObjectReference(obj)
      }
    }

    implicit def jsonReadsPostmanGeneratorAttributesValueSubstitute: play.api.libs.json.Reads[io.postman.generator.attributes.v0.models.ValueSubstitute] = {
      (__ \ "substitute").read[String].map { x => ValueSubstitute(substitute = x) }
    }
    ...
    implicit def jsonWritesPostmanGeneratorAttributesValueSubstitute: play.api.libs.json.Writes[ValueSubstitute] = {
      (obj: io.postman.generator.attributes.v0.models.ValueSubstitute) => {
        io.postman.generator.attributes.v0.models.json.jsObjectValueSubstitute(obj)
      }
    }
  }
}
...
package io.postman.generator.attributes.v0 {
  ...
  object Constants {
    ...
    val Namespace = "io.postman.generator.attributes.v0"
    val UserAgent = "apibuilder app.apibuilder.io/apicollective/postman-generator-attributes/latest/play_2_9_scala_3_client"
  ...
  class Client(
    ...
    val baseUrl: String,
    auth: scala.Option[io.postman.generator.attributes.v0.Authorization] = None,
    defaultHeaders: Seq[(String, String)] = Nil
  ) extends interfaces.Client {
    import io.apibuilder.spec.v0.models.json._
    import io.postman.generator.attributes.v0.models.json._

    private val logger = play.api.Logger("io.postman.generator.attributes.v0.Client")

    logger.info(s"Initializing io.postman.generator.attributes.v0.Client for url $baseUrl")
    ...
    def parseJson[T](
      ...
      f(play.api.libs.json.Json.parse(r.body)) match {
        ...
        case play.api.libs.json.JsError(errors) => {
          throw io.postman.generator.attributes.v0.errors.FailedRequest(r.status, s"Invalid json for class[" + className + "]: " + errors.mkString(" "))
        }
      }
    }
