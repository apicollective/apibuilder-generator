...
class ParserGenerator28Spec extends FunSpec with Matchers {
  ...
  it("model with one field") {
    ...
    ParserGenerator28.invoke(form) match {
      ...
      case Right(files) => {
        ...
        models.TestHelper.assertEqualsFile("/generator/anorm/reference-conversions-28.txt", files.head.contents)
  ...
  it("model with multiple fields") {
    ...
    ParserGenerator28.invoke(form) match {
      ...
      case Right(files) => {
        files.map(_.name) should be(fileNames)
        models.TestHelper.assertEqualsFile("/generator/anorm/name-conversions-28.txt", files.head.contents)
  ...
  it("model with capitalized fields") {
    ...
    ParserGenerator28.invoke(form) match {
      ...
      case Right(files) => {
        files.map(_.name) should be(fileNames)
        models.TestHelper.assertEqualsFile("/generator/anorm/cap-name-conversions-28.txt", files.head.contents)
  ...
  it("composite model") {
    ...
    ParserGenerator28.invoke(form) match {
      ...
      case Right(files) => {
        files.map(_.name) should be(fileNames)
        models.TestHelper.assertEqualsFile("/generator/anorm/user-conversions-28.txt", files.head.contents)
  ...
  it("enum model") {
    ...
    ParserGenerator28.invoke(form) match {
      ...
      case Right(files) => {
        files.map(_.name) should be(fileNames)
        models.TestHelper.assertEqualsFile("/generator/anorm/enum-conversions-28.txt", files.head.contents)
  ...
  it("model with list field") {
    ...
    ParserGenerator28.invoke(form) match {
      ...
      case Right(files) => {
        files.map(_.name) should be(fileNames)
        models.TestHelper.assertEqualsFile("/generator/anorm/list-conversions-28.txt", files.head.contents)
  ...
  it("with union type") {
    ...
    ParserGenerator28.invoke(form) match {
      ...
      case Right(files) => {
        files.map(_.name) should be(fileNames)
        models.TestHelper.assertEqualsFile("/generator/anorm/union-conversions-28.txt", files.head.contents)
  ...
  it("model with fields that are composite names") {
    ...
    ParserGenerator28.invoke(form) match {
      ...
      case Right(files) => {
        files.map(_.name) should be(fileNames)
        models.TestHelper.assertEqualsFile("/generator/anorm/location-conversions-28.txt", files.head.contents)
