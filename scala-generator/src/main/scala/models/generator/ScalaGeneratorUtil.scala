  ...
  object PathParamHelper {
    def urlEncode(
      ...
      d match {
        ...
        case dt @ (ScalaPrimitive.DateIso8601Joda | ScalaPrimitive.DateIso8601Java | ScalaPrimitive.DateTimeIso8601Joda | ScalaPrimitive.DateTimeIso8601Java) => dt.asString(name)
