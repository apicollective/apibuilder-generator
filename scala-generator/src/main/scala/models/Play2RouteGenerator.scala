...
private[models] case class Play2Route(
  ...
  private def defaultForPrimitive(
    ...
    case ScalaPrimitive.String | ScalaPrimitive.DateIso8601Joda | ScalaPrimitive.DateIso8601Java | ScalaPrimitive.DateTimeIso8601Joda | ScalaPrimitive.DateTimeIso8601JavaInstant | ScalaPrimitive.Uuid | ScalaPrimitive.Enum(_, _) => {
      value
    }
