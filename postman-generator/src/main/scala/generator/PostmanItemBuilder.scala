...
object PostmanItemBuilder extends Logging {
  ...
  /**
    * Builds a runnable Postman Item from ApiBuilder operation.
    * All fields are filled with example values generated by {{ExampleJson}}.
    *
    * @param operation an input ApiBuilder operation
    * @param serviceSpecificHeaders a set of service-specific headers that will be added to the headers from the input operation
    * @param modelExampleProvider an example provider, which will be used to generate example values
    * @param pathVariableOpt optionally, provides a Postman variable for given path param
    * @return a runnable Postman Item
    */
  def build(
    operation: Operation,
